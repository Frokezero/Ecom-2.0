    ...
    <?php else: ?>
        <div class="cart-layout" style="display: grid; grid-template-columns: 1.8fr 1fr; gap: 32px;">
            ...
            <div class="cart-summary" style="background: white; border-radius: var(--radius-md); border: 1px solid var(--border-color); padding: 24px; height: fit-content; box-shadow: var(--shadow-sm);">
                ...
                <div class="coupon-picker" data-coupon-selector data-subtotal="<?php echo (float)$grand_total; ?>" data-base-total="<?php echo (float)$cartCharges['total']; ?>" data-base-shipping="<?php echo (float)$cartCharges['shipping']; ?>" data-base-tax="<?php echo (float)$cartCharges['tax']; ?>" data-total-target="cartTotal" data-discount-target="cartCouponDiscount" data-discount-row="cartCouponDiscountRow" data-shipping-target="cartShipping" data-tax-target="cartTax">
