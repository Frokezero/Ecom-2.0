        ...
        <div class="checkout-grid">
            ...
            <div>
                <div class="checkout-card" style="position: sticky; top: 100px;">
                    ...
                    <div class="coupon-picker" data-coupon-selector data-subtotal="<?php echo (float)$grand_total; ?>" data-base-total="<?php echo (float)$checkoutCharges['total']; ?>" data-base-shipping="<?php echo (float)$checkoutCharges['shipping']; ?>" data-base-tax="<?php echo (float)$checkoutCharges['tax']; ?>" data-total-target="checkoutTotal" data-discount-target="couponDiscount" data-discount-row="couponDiscountRow" data-shipping-target="checkoutShipping" data-tax-target="checkoutTax">
                        <button type="button" class="coupon-picker-trigger" data-coupon-open><span><i class="fa-solid fa-ticket"></i><b>คูปองส่วนลด</b><small data-coupon-summary>ยังไม่ได้ใช้คูปอง — กดเพื่อเลือก</small></span><i class="fa-solid fa-chevron-right"></i></button>
                        <div class="coupon-picker-overlay" data-coupon-modal><div class="coupon-picker-dialog"><header><h3>เลือกโค้ดส่วนลด</h3><button type="button" data-coupon-close aria-label="ปิด">&times;</button></header><div class="coupon-picker-body"><div class="coupon-slot" data-coupon-slot="shipping"><label><i class="fa-solid fa-truck-fast"></i> โค้ดส่งฟรี</label><select data-coupon-select><option value="">ไม่ใช้ส่วนลดค่าจัดส่ง</option></select><div class="coupon-code-row"><input data-coupon-input placeholder="กรอกรหัสส่วนลดค่าส่ง"><button type="button" data-coupon-apply class="btn btn-outline">ใช้โค้ด</button></div><small data-coupon-message></small></div><div class="coupon-slot" data-coupon-slot="product"><label><i class="fa-solid fa-tags"></i> โค้ดส่วนลดสินค้า / เงินสด</label><select data-coupon-select><option value="">ไม่ใช้ส่วนลดสินค้า</option></select><div class="coupon-code-row"><input data-coupon-input placeholder="กรอกรหัสส่วนลดสินค้า"><button type="button" data-coupon-apply class="btn btn-outline">ใช้โค้ด</button></div><small data-coupon-message></small></div></div><footer><button type="button" class="btn btn-outline" data-coupon-close>ยกเลิก</button><button type="button" class="btn btn-primary" data-coupon-confirm>ตกลง</button></footer></div></div>
                    </div>
