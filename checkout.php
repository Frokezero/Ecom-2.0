            ...
            <div>
                <div class="checkout-card" style="position: sticky; top: 100px;">
                    ...
                    <div class="coupon-picker" data-coupon-selector data-subtotal="<?php echo (float)$grand_total; ?>" data-base-total="<?php echo (float)$checkoutCharges['total']; ?>" data-base-shipping="<?php echo (float)$checkoutCharges['shipping']; ?>" data-base-tax="<?php echo (float)$checkoutCharges['tax']; ?>" data-total-target="checkoutTotal" data-discount-target="couponDiscount" data-discount-row="couponDiscountRow" data-shipping-target="checkoutShipping" data-tax-target="checkoutTax">
                        <button type="button" class="coupon-picker-trigger" data-coupon-open><span><i class="fa-solid fa-ticket"></i><b>คูปองส่วนลด</b><small data-coupon-summary>เลือกส่วนลดสินค้าและค่าจัดส่ง</small></span><i class="fa-solid fa-chevron-right"></i></button>
