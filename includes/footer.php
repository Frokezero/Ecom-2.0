...
?>
    ...
    <script src="<?php echo BASE_URL; ?>assets/js/address-picker.js?v=5"></script>
    ...
    <script src="<?php echo BASE_URL; ?>assets/js/coupon-selector.js?v=8"></script>
    <script src="<?php echo BASE_URL; ?>assets/js/image-crop.js"></script>
    <script src="<?php echo BASE_URL; ?>assets/js/cart.js?v=7"></script>
    ...
    <?php if (basename($_SERVER['PHP_SELF'] ?? '') === 'index.php'): ?><script src="<?php echo BASE_URL; ?>assets/js/home-banner-carousel.js?v=3"></script><?php endif; ?>
