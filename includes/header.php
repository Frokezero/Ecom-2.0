    ...
    <header class="site-header">
        ...
        <nav class="site-nav" id="siteNav" aria-label="เมนูหลัก">
            <div class="container">
                ...
                <?php if (isSeller()): ?><a href="<?php echo BASE_URL; ?>seller-dashboard.php" class="<?php echo str_starts_with($current_page,'seller-')||$current_page==='my-store.php'?'active':''; ?>"><i class="fa-solid fa-store"></i> ศูนย์ผู้ขาย</a><?php endif; ?>
