...
function verificationEmailHtml(string $safeName, string $safeUrl): string {
    return '<!doctype html><html lang="th"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"></head>'
        ...
        . '<tr><td style="padding:26px 32px;background:#173f32;color:#ffffff"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td style="font-size:24px;font-weight:700;letter-spacing:-.4px">KitchenMate</td><td align="right" style="font-size:11px;letter-spacing:1.2px;color:#c3d5cc">ACCOUNT SECURITY</td></tr></table></td></tr>'
        ...
        . '<p style="margin:0 0 25px;font-size:15px;line-height:1.75;color:#53635d">กดปุ่มด้านล่างเพื่อยืนยันอีเมลและเปิดใช้งานบัญชี KitchenMate ของคุณ ลิงก์นี้ใช้ได้ภายใน <strong style="color:#173f32">30 นาที</strong></p>'
        ...
        . '<div style="margin-top:31px;padding:16px 18px;background:#f8f7f2;border-left:3px solid #d88b4d"><p style="margin:0;font-size:12px;line-height:1.65;color:#68746f">หากคุณไม่ได้สมัครสมาชิก KitchenMate คุณไม่ต้องดำเนินการใด ๆ และสามารถละเว้นอีเมลฉบับนี้ได้</p></div>'
        ...
        . '</td></tr><tr><td style="padding:21px 32px;background:#173f32;text-align:center;color:#b9cec3;font-size:11px;line-height:1.6">KitchenMate · อุปกรณ์ครัวสำหรับทุกบ้าน<br>อีเมลนี้ใช้สำหรับยืนยันบัญชี</td></tr>'
...
function sendPasswordResetEmail(string $email, string $fullName, string $token): void {
    ...
    $html='<!doctype html><html lang="th"><meta charset="UTF-8"><body style="margin:0;background:#f4f1e9;font-family:Arial,Tahoma,sans-serif;color:#23332e"><table width="100%" role="presentation"><tr><td align="center" style="padding:32px 14px"><table width="600" role="presentation" style="max-width:600px;background:#fff;border:1px solid #e3dfd2"><tr><td style="padding:26px 32px;background:#173f32;color:#fff;font-size:24px;font-weight:700">KitchenMate</td></tr><tr><td style="padding:38px 32px"><p style="color:#b45c28;font-size:12px;font-weight:700">ACCOUNT SECURITY</p><h1 style="font-family:Georgia,serif;color:#173f32">ตั้งรหัสผ่านใหม่</h1><p>สวัสดี '.$safeName.' มีคำขอตั้งรหัสผ่านใหม่สำหรับบัญชีของคุณ ลิงก์นี้ใช้ได้ 30 นาทีและใช้ได้เพียงครั้งเดียว</p><p style="margin:28px 0"><a href="'.$safeUrl.'" style="background:#173f32;color:#fff;padding:14px 22px;text-decoration:none;font-weight:700">ตั้งรหัสผ่านใหม่ →</a></p><p style="font-size:12px;color:#68746f">หากคุณไม่ได้เป็นผู้ร้องขอ ให้ละเว้นอีเมลนี้และรหัสผ่านเดิมจะยังใช้งานได้</p></td></tr></table></td></tr></table></body></html>';
    sendAppMail($email,'ตั้งรหัสผ่านใหม่สำหรับบัญชี KitchenMate',$html);
}
