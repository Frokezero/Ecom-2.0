...
<div class="admin-shell">
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="admin-nav" aria-label="เมนูผู้ดูแล">
            ...
            <a href="<?php echo BASE_URL; ?>admin/products.php" class="<?php echo $admin_page==='products.php'?'active':''; ?>"><i class="fa-solid fa-boxes-stacked"></i><span>สินค้าของเว็บไซต์</span></a>
            ...
            <a href="<?php echo BASE_URL; ?>admin/stores.php" class="<?php echo in_array($admin_page,['stores.php','store-detail.php'],true)?'active':''; ?>"><i class="fa-solid fa-shop-lock"></i><span>ร้านค้าและสินค้า</span></a>
            ...
            <a href="<?php echo BASE_URL; ?>admin/behavior-analytics.php" class="<?php echo $admin_page==='behavior-analytics.php'?'active':''; ?>"><i class="fa-solid fa-chart-line"></i><span>Behavior Analytics</span></a>
