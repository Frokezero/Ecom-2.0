...
$migration=(int)$db->query("SELECT COUNT(*) FROM schema_migrations WHERE version='018_production_hardening.sql'")->fetchColumn();if(!$migration)$issues[]='migration_018_missing';
