...
$migration=(int)$db->query("SELECT COUNT(*) FROM schema_migrations WHERE version='031_product_primary_media.sql'")->fetchColumn();if(!$migration)$issues[]='migration_031_missing';
