...
if (!headers_sent()) {
    ...
    $csp = "default-src 'self'; base-uri 'self'; frame-ancestors 'self'; frame-src 'self' https://www.youtube-nocookie.com; form-action 'self'; object-src 'none'; img-src 'self' data: https:; font-src 'self' https://cdnjs.cloudflare.com https://fonts.gstatic.com data:; style-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://fonts.googleapis.com; script-src 'self' 'nonce-".cspNonce()."'; script-src-attr 'unsafe-inline'; connect-src 'self' https://raw.githubusercontent.com";
