...
$required=['payment_transactions','return_requests','return_request_items','refunds','seller_ledger','audit_logs','login_attempts','password_reset_tokens','order_fulfillments','user_addresses','wishlists','product_images','product_variants','auth_challenges'];
