...
$expectedTax=0.0;
if(abs($charges['shipping']-$expectedShipping)>.001||abs($charges['tax']-$expectedTax)>.001||abs($charges['total']-($low+$expectedShipping))>.001)throw new RuntimeException('Mall shipping calculation mismatch');
